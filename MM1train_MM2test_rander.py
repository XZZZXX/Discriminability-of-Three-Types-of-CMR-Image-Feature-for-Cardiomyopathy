...
train_filePath = r'E:\shijie\features\train_24.xlsx'
test_filePath = r'E:\shijie\features\test_24.xlsx'
name_list = ['id','label','LV_ES_Stdx', 'LV_ES_Stdy', 'LV_ES_V','MYO_ES_Stdx','MYO_ES_Stdy']
...
# Voting Classifier
E_clf = VotingClassifier(estimators=[ ('mlp',MLP_clf),('svm',SVM_clf)],
                             voting='soft')
